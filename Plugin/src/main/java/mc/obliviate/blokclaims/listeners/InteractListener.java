...
public class InteractListener extends ListenerHandler implements Listener {
    ...
    public void onInteractEvent(PlayerInteractEvent e) {
        ...
        if (e.getAction().equals(Action.RIGHT_CLICK_BLOCK) || e.getAction().equals(Action.LEFT_CLICK_BLOCK)) {
            ...
            final Claim claim = getClaimUtils().getClaimManager().getClaimData(e.getClickedBlock().getLocation());
            ...
            if (type.equals(Material.BEDROCK)) {
                ...
                if (claim.getMembers().containsKey(e.getPlayer().getUniqueId())) {

                    if (claim.getMainBlock().equals(e.getClickedBlock().getLocation())) {

                        new ClaimStoneGUI(e.getPlayer(), claim).open();
                        e.setCancelled(true);
                    }
                } else {
                    e.setCancelled(true);
                    MessageUtils.sendMessage(e.getPlayer(), "claim-guard.interact-cancel");
                }
                ...
                if (!permState) {
                    e.setCancelled(true);
                    MessageUtils.sendMessage(e.getPlayer(), "claim-guard.use-containers-cancel");
                ...
                if (!permState) {
                    e.setCancelled(true);
                    MessageUtils.sendMessage(e.getPlayer(), "claim-guard.powerable-cancel");
    ...
    public void onPhysicalInteract(PlayerInteractEvent e) {
        ...
        switch (e.getClickedBlock().getType()) {
            ...
            case FARMLAND:
                ...
                if (!farmPerm) {
                    e.setCancelled(true);
                    MessageUtils.sendMessage(e.getPlayer(), "claim-guard.farmland-destroy-cancel");
                }
                break;
            case TRIPWIRE:
